...
class PdfService {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(width: 220, child: _buildHeader(font, fontBold)),
                ...
                children: [
                  ...
                  pw.Container(
                    ...
                    child: _buildSectionTable(
                      ...
                      user.pendidikanKepolisian
                          .map((item) => [item.tingkat, item.tahun.toString()])
                          .toList(),
                      font,
                      fontBold,
                      columnWidth: 160,
                  ...
                  pw.Container(
                    ...
                    child: _buildSectionTable(
                      ...
                      user.riwayatPangkat
                          .map(
                            (item) => [item.pangkat, _formatDateTMT(item.tmt)],
                          )
                          .toList(),
                      font,
                      fontBold,
                ...
                children: [
                  ...
                  pw.Container(
                    ...
                    child: _buildSectionTable(
                      ...
                      user.riwayatJabatan
                          .map(
                            (item) => [item.jabatan, _formatDateTMT(item.tmt)],
                          )
                          .toList(),
                      font,
                      fontBold,
                      ...
                      children: [
                        ...
                        _buildSectionTable(
                          ...
                          user.kemampuanBahasa
                              .map((item) => [item.bahasa, item.status])
                              .toList(),
                          font,
                          fontBold,
                          columnWidth: 200,
  ...
  static pw.Widget _buildBasicInfoTable(
    ...
    return pw.Column(
      ...
      children: [
        ...
        _buildInfoRow(
          'Jabatan/TMT',
          '${user.jabatan}${user.jabatanTmt != null ? ' (${user.formattedJabatanTmt})' : ''}',
          font,
          fontBold,
        ),
  ...
  static pw.Widget _buildBottomSections(
    UserModel user,
    pw.Font font,
    pw.Font fontBold,
  ) {
        ...
        user.penugasanLuarStruktur.isNotEmpty
            ? pw.Table(
              ...
              children: [
                ...
                // Data rows
                ...user.penugasanLuarStruktur.map(
                  (item) => pw.TableRow(
                    children: [
                      pw.Container(
                        padding: const pw.EdgeInsets.all(3),
  ...
  static pw.Widget _buildFooterSignature(
    UserModel user,
    pw.Font font,
    pw.Font fontBold,
  ) {
    ...
    final dateString =
        'Jakarta, ${now.day.toString().padLeft(2, '0')} - ${now.month.toString().padLeft(2, '0')} - ${now.year}';
    ...
    return pw.Row(
      ...
      children: [
        pw.Column(
          crossAxisAlignment: pw.CrossAxisAlignment.center,
          children: [
            pw.Text(dateString, style: pw.TextStyle(font: font, fontSize: 9)),
            pw.Text(
